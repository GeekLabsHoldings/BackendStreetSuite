...
# url = f"https://tools.optionsai.com/earnings/ELV"

# response = requests.get(url=url)
# soup = BeautifulSoup(response.text,'html.parser')


# all_paragraphs = soup.find_all('p',class_="MuiTypography-root jss142 jss145 jss144 MuiTypography-body1")
# print(all_paragraphs)

# percentage = all_paragraphs[1]

# print(f"percentage text:{percentage}")
from Alerts.Scraping.EarningsScraper import earning_scraping

value = earning_scraping(ticker_symbol="ELV")
print(value)
