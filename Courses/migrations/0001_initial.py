# Generated by Django 5.0.6 on 2024-08-06 06:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assessment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='assessment_completed', to='Courses.assessment')),
                ...
                ('module', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='completed', to='Courses.module')),
            ],
        ),
        migrations.AddField(
