...
from .views import   EMA_DAY , get_13f , RSI_4hour , RSI_1day , EMA_4HOUR , EMA_1HOUR , AlertListView , Earnings , volume , jojo , ListAlerts

urlpatterns = [
    # path('', AlertListView.as_view() , name='list_alerts'),
    path('', ListAlerts.as_view() , name='list_alerts'),
